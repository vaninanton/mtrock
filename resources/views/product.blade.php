<x-app-layout>
    <div class="flex bg-gray-50 px-4 py-2">
        <ol class="inline-flex items-center space-x-1 md:space-x-3" aria-label="Breadcrumb">
            <li class="inline-flex items-center">
                <a class="inline-flex items-center text-sm font-medium text-blue-700 hover:text-blue-900" href="/">
                    Mountain-Rock
                </a>
            </li>
            <li class="inline-flex items-center">
                <a class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900" href="/store/palatki">
                    Палатки
                </a>
            </li>
            <li class="inline-flex items-center">
                <a class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900" href="/store/palatki/palatka-alexika-mirage-4-krasnyy.html">
                    Mirage 4 красный
                </a>
            </li>
        </ol>
    ...
    <div class="grid md:grid-flow-col">
        <div class="p-4 md:order-2">
            <h1 class="font-bold text-xl" itemprop="name">{{ $product->title }}</h1>
            <div class="text-lg pb-4 mb-6 border-b">{{ $product->short_description }}</div>
            <div class="flex gap-4">
                <div class="flex-1 text-right">
                    @if($product->old_price && $product->old_price > $product->price)
                    <del class="block line-through decoration-red-300">@money($product->old_price, 4)</del>
                    @endif
        ...
        <div class="bg-white md:order-1 p-4">
            <img src="https://picsum.photos/400/300?random=13445" alt="" class="block h-auto w-full">
            <div class="flex justify-center items-center gap-4 mt-4">
                <a href="#">
                    <img src="https://picsum.photos/40/30?random=12345" alt="" class="transition-transform transform-gpu hover:scale-150">
                </a>
                <a href="#">
                    <img src="https://picsum.photos/30/30?random=12345" alt="" class="transition-transform transform-gpu hover:scale-150">
                </a>
                <a href="#">
                    <img src="https://picsum.photos/30/40?random=12345" alt="" class="transition-transform transform-gpu hover:scale-150">
                </a>
                <a href="#">
                    <img src="https://picsum.photos/30/10?random=12345" alt="" class="transition-transform transform-gpu hover:scale-150">
                </a>
            </div>
        </div>
    </div>
    <div class="relative mx-[-1px]">
        <div class="grid md:grid-cols-3 bg-blue-900 text-white fill-white">
            <a href="/contact" target="_blank" rel="nofollow" class="py-8 px-8">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-auto w-1/4 w-sm-25">
            ...
            <a href="/oplata-i-dostavka" target="_blank" rel="nofollow" class="py-8 px-8">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -36 512 512" class="h-auto w-1/4 w-sm-25">
            ...
            <a href="/dostavka-dostavka-turisticheskih-tovarov-i-snaryazheniya-po-rossii-i-stranam-sng" target="_blank" rel="nofollow" class="py-8 px-8">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -66 512 512" class="h-auto w-1/4 w-sm-25">
    ...
    <div class="flex">
        ...
        <div class="flex-0 py-8 px-4 border-l w-72">
