...
<x-app-layout>
    ...
    <div class="container mx-auto">
        ...
        <div class="lg:absolute lg:z-1 lg:w-screen lg:left-0">
            <div class="bg-primary text-white lg:pl-[30%]">
                <div class="grid sm:grid-cols-3">
                    <a href="{{ route('page', 'contact') }}" target="_blank" rel="nofollow" class="py-8 px-8">
                    ...
                    <a href="{{ route('page', 'oplata-i-dostavka-po-moskve-i-rossii') }}" target="_blank" rel="nofollow" class="py-8 px-8">
