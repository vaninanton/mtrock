...
<x-app-layout>
    <x-top-header class="-mb-20" h1="Контакты и пункт самовывоза" subheading="<strong>ВНИМАНИЕ!</strong><br>В пункте самовывоза находится только предварительно заказанный товар!">
        <x-slot:breadcrumbs>
    ...
    <div class="container mx-auto">
        <div class="grid lg:grid-cols-2">
            ...
            <div id="contact_us_map" class="h-80 md:h-full w-full -mx-0 rounded-t-xl overflow-hidden"></div>
        </div>
        <div class="p-4">
