...
<x-app-layout>
    <nav class="flex bg-gray-100 py-2 px-4" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li class="inline-flex items-center">
                <a href="{{ route('news.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">{{ $news->title }}</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="p-4">
        <div class="flex justify-between items-center">
            ...
            <time class="small" datetime="{{ $news->created_at->format('Y-m-d') }}" pubdate>{{ $news->created_at->format('d.m.Y') }}</time>
        </div>
